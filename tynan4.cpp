...
// Postcondition: The items in the sequence will be printed to cout.
...
int main( ){
	...
	sequence test2; // Used for assignment test
    ...
    do
    {
        ...
        switch (choice)
        {
            ...
            case 'R': test.remove_current( );
                      ...
                      break;     
			case 'X': cout << "Printing copied sequence through a copy constructor." << endl; 
				      show_sequence(test);
					  break;
			case 'D': test.~sequence();
				      ...
				      break;
			case 'T': test.tail(); 
					  cout << "current_ptr is now set to the tail." << endl;
					  break;
			case '-': test.moveback();
				      break;
			case '=': test2 = test;
				      cout << "test2 has been assigned the values of test." << endl;
				      show_sequence(test2);
					  break;
...
void print_menu( )
{
	...
	cout << " X   Tests the copy constructor on test." << endl; 
	cout << " D   Clears Test." << endl;
	cout << " T   Set the current_ptr = tail" << endl;
	cout << " -   Activate the moveback( ) function" << endl;
	cout << " =   Sets test2 = test." << endl;
...
char get_user_command( )
{
    ...
    cout << "Enter choice: ";
    cin >> command; // Input of character
...
void show_sequence(sequence display)
{	
	cout << "The sequence going forwards contains : ";
	for (display.start( ); display.is_item( ); display.advance( ))
        cout << display.current( ) << " ";
	cout << endl;

	cout << "The sequence going backwards contains : "; // Added a backwards display
	for (display.tail(); display.is_item(); display.moveback( ))
		cout << display.current() << " ";
	cout << endl;
}
